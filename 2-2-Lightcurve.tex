...
\texttt{peek()} method. The maximum flux value in the GOES 1.0 - 8.0$\AA$\ channel 
...
\texttt{LightCurve} object may be initialised using that file as input.
%Once the \texttt{LightCurve} object has been created, it may be manipulated in 

...
\texttt{LightCurve} respectively. Each data type has a \texttt{.data} 
...
a per-instrument basis, \textit{i.e.} \texttt{Map} has a 
...
sources each data type supports different visualisation wrappers that 
...
make sure that the current state of the figure and axes is mantined 
